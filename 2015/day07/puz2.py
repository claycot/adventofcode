...
def main() -> int:
    ...
    wires[OVERRIDDEN_WIRE] = ("IS", [solution])
    wires_solved = {}

    new_solution = solve_wire(DESIRED_WIRE, wires, wires_solved)
    
    print(f"the new solution for wire {DESIRED_WIRE} is {new_solution} jolts")
    return new_solution
